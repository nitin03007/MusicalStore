...
<body>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2-img-detail">
                    <img src="img/Products/ctk3500/ctk3500-1.jpg" alt="" width="100%" height="100%" id="ProductImg">
                    
                    <div class="small-img-row">
                        <div class="small-img-col">
                                <img src="Img/Products/ctk3500/ctk3500-1.jpg" alt="" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="Img/Products/ctk3500/ctk3500-2.jpg" alt="" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="Img/Products/ctk3500/ctk3500-3.jpg" alt="" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="Img/Products/ctk3500/ctk3500-4.jpg" alt="" class="small-img">
                        </div>

                    </div>
                </div>
                <div class="col-2-img-detail" style="margin-bottom: 150px;">
                    <form action="manage-cart.php" method="POST">
                        <p>Instrument /Piano</p>
                        <h1>Casio CTK-3500 61-Key Portable Keyboard</h1>
                        <h4>Rs 8500</h4>
                        <input type="number" value="1" maxlength="5" minlength="1">
                        <button type="submit" name="Add_To_Cart" id="cart" class="btn">Add to Cart</button>
                        ...
                        <br>
                        <p>Product Description Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi et voluptates vel asperiores Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam illum veritatis, id ea dolor eaque.</p>
                    </form>
                </div>
            </div>
        </div>
